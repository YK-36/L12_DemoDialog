package sg.edu.rp.c346.id22015127.demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Obtain the UI component in the input.xml layout
                // It needs to be defined as "final", so that it can used in the onClick() method later
                final EditText etNo1 = viewDialog.findViewById(R.id.No1);
                final EditText etNo2 = viewDialog.findViewById(R.id.No2);
        ...
        btnDemo4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog myDateDialog = new DatePickerDialog(MainActivity.this, myDateListener, calender.get(Calendar.YEAR), calender.get(Calendar.MONTH), calender.get(Calendar.DAY_OF_MONTH));
                myDateDialog.show();
            }
        });
